...
export default function DashboardClient({ assets: serverAssets, alerts: initialAlerts, marketNews }: DashboardClientProps) {
  ...
  const handleOpenTradeDialog = (asset: Asset, type: 'buy' | 'sell') => {
    setTradeAsset(asset);
    setTradeType(type);
  ...
  const handleAITrade = (tradeType: 'buy' | 'sell') => {
    handleOpenTradeDialog(selectedAsset, tradeType);
  };
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 space-y-6">
              ...
              <div className="grid gap-6 xl:grid-cols-3">
                <div className="xl:col-span-2 flex flex-col gap-6">
                  <AITradingInsights insights={insights} loading={loadingInsights} onTrade={handleAITrade} />
